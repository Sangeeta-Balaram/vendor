  ...
  return (
    <section className="pt-2 pb-16 md:pb-24 px-4 sm:px-6">
      <div className="max-w-[1100px] mx-auto">
        <h2 className="text-center text-[22px] sm:text-[28px] md:text-[32px] font-extrabold tracking-[-.03em] mb-8 md:mb-12 bg-gradient-to-r from-blue-700 to-purple-700 bg-clip-text text-transparent">The perfect blend of creativity &amp; technology</h2>
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-0 relative">
            <motion.div
              ...
              className="bg-white rounded-t-[24px] md:rounded-l-[24px] md:rounded-tr-none p-6 shadow-soft relative overflow-hidden"
            >
            ...
            <div className="flex md:hidden justify-center -my-3 relative z-10">
              <div className="w-16 h-16 rounded-full bg-white shadow-xl flex items-center justify-center border-[4px] border-white">
            ...
            <motion.div
              initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              className="bg-white rounded-b-[24px] md:rounded-r-[24px] md:rounded-bl-none p-6 shadow-soft relative overflow-hidden"
            >
