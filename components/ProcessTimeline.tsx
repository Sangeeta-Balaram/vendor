...
export default function ProcessTimeline() {
  return (
    <section id="how-it-works" className="pt-16 pb-24 px-6 bg-white">
      ...
      <div className="max-w-[1200px] mx-auto flex justify-center items-start gap-2 lg:gap-3">
        {steps.map((s, i) => (
          <div key={s.label} className="flex items-center gap-2 lg:gap-3">
            <motion.div
              initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              transition={{ delay: i * 0.07 }}
              className="flex flex-col items-center text-center w-[100px] md:w-[120px]"
            >
